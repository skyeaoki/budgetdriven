    ...
    render() {
        ...
        return (
            <div className="header">
                ...
                <p className="leftToSpend"><span className="dollarSign">$</span>{leftToSpend && leftToSpend.toFixed(2)}</p>
                <div className="progressBar">
                    <div style={{"width" : this.props.progressBar + "%"}}></div>
                </div>
                <div className="progressBarAmounts">
                    <span className="totalSpent">${totalSpent && totalSpent.toFixed(2)} <span className="spent">spent</span></span> 
